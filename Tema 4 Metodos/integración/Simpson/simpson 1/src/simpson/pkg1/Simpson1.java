...
public class Simpson1 {
    ...
    public static void main(String[] args) {
        // Ejemplo de puntos x y y para una función lineal (f(x) = x)
        double[] x = {0.0, 1.0, 2.0, 3.0}; // Puntos x
        double[] y = {0.0, 1.0, 2.0, 3.0}; // Puntos y (x)
...
//La integral definida de la función es: 2.0